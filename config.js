...
let config = {
	...
	modules: [
				...
				calendars: [
					{
						...
						url: "https://ics.calendarlabs.com/75/5aed7e90/UK_Holidays.ics"
					}
				]
			}
		},
		{
			...
			config: {
				remoteFile: "/home/paul/MagicMirror/config/compliments.json"
			}
		},
		{
			module: "weather",
			...
			config: {
				...
				apiKey: "4cb86e0e4a900754be463e0cdd3357ca"
			}
		},
		{
			module: "weather",
